...
public class MixinReloadScreenManager {
    ...
    private static void starac_onStartupThreaded(
        ...
        try {
            ...
            val screenScaler = new ScreenScaler(minecraft.options, minecraft.displayWidth, minecraft.displayHeight);
            val screen = (net.minecraft.client.gui.screen.Screen) localReloadScreen;
            ...
            while (!done.get()) {
                ...
                timer.advance();
                timer.partialTick = f;
                val mouseX = Mouse.getX() * widthVal / minecraft.displayWidth;
                val mouseY = heightVal - Mouse.getY() * heightVal / minecraft.displayHeight - 1;
